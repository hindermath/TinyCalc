...
$script:ExpectedPresets = [ordered]@{
    ...
    'intake-authoring-governance' = @{ Version = '0.3.2'; Priority = 'NotInStandardMatrix'; Standard = $false; Families = @('CL-09', 'CL-12'); Gates = @('001', '032', '033') }
    'intake-review-governance' = @{ Version = '0.2.2'; Priority = 'NotInStandardMatrix'; Standard = $false; Families = @('CL-08', 'CL-09', 'CL-12'); Gates = @('001', '028', '032') }
    'intake-sequencing-governance' = @{ Version = '0.2.4'; Priority = 'NotInStandardMatrix'; Standard = $false; Families = @('CL-09', 'CL-12'); Gates = @('001', '032', '033') }
