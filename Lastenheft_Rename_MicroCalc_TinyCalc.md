...
```text
Ersetzter Alt-Prompt: speckit-specify Nutze Lastenheft_Rename_MicroCalc_TinyCalc.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Umbenennungs- und Migrationslauf im Repository TinyCalc.
