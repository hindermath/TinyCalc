...
```text
/speckit-specify Nutze Lastenheft_TerminalGui_Migration.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Terminal.Gui-Migrations- und Kompatibilitaetslauf im Repository TinyCalc.
