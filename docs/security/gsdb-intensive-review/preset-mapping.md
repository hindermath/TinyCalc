...
| `autonomous-run-governance` | 0.4.3 | 70 | Standard | CL-05, CL-09, CL-12; Gates 001, 002, 027-033 | `bf5f848db7011b6bd3082b505a2134519c8dcf29365082f8d1177df72679906d` |
...
## Revalidierung v0.4.3 / v0.4.3 Revalidation
...
und Gate-001/002/027-033-Zuordnung bleibt fachlich unverändert. Die exakte
Staging-Mengen- und Indexbyte-Prüfung von v0.4.3 stärkt Gate 027; sie ändert
keine Produkt-, Human-only- oder Erfüllungsdisposition.
...
CL-05/CL-09/CL-12 and gate 001/002/027-033 mapping remains valid. Version 0.4.3
strengthens gate 027 through exact staged-set and index-byte checks; it changes
